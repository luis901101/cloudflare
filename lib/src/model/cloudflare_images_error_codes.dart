class CloudflareImagesErrorCodes {
  ...
  static const givenAccountIsNotValidOrIsNotAuthorizedToAccessThisService = 5403;	//The given account is not valid or is not authorized to access this service
  static const imageNotFound = 5404;	//Image not found
  static const clientWasSendingUploadTooSlowly = 5408;	//Client was sending upload too slowly
  static const maximumImageSizeOf10MbIsReached = 5413;	//Maximum image size of 10 Mb is reached
  static const imagesMustBeUploadedAsAFormNotAsRawImageData = 5415;	//Images must be uploaded as a form not as raw image data
  static const requestHasBeenAbortedByTheClient = 5433;	//Request has been aborted by the client
  static const errorWhileReceivingUpload = 5450;	//Error while receiving upload
  static const theGivenAccountHasReachedAServiceLimit = 5453;	//The given account has reached a service limit
  ...
  static const errorReceivedFromTheStorage = 5540;	//Error received from the storage
