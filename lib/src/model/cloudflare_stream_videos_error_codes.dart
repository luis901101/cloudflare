class CloudflareStreamVideosErrorCodes {
  ...
  static const conflictMediaHasBeenModifiedSinceLastRequest = 100013; //Conflict Media has been modified since last request
  static const authorizationFailureCredentialNotAuthorized = 10002;	//Authorization Failure Credential not authorized
  static const notFoundResourceNotFound = 10003;	//Not Found Resource not found
  static const decodingErrorCannotDecodeRequestBody = 10004;	//Decoding Error Cannot decode request body
  static const badRequest = 10005;	//Bad Request
  static const betaAccessError = 10006;	//Beta Access Error
  static const forbiddenCopyUploadNotEnabled = 10007;	//Forbidden Copy upload not enabled
  static const invalidDuration = 10008;	//Invalid Duration
  static const forbiddenAllowedKeyCountExceeded = 10009;	//Forbidden Allowed key count exceeded
  static const invalidUrl = 10010;	//Invalid URL
  static const fileSizeTooLarge = 10011;	//File size too large
  static const forbiddenWebhookFeatureNotEnabled = 10012;	//Forbidden Webhook feature not enabled
  ...
  static const expirationForUploadHasPassed = 10017;	//Expiration for upload has passed
